...
export default function Experience() {
  ...
  const sampleProvenance = displayFeed?.scope === "archive" ? "ARCHIVED SAMPLE" : displayFeed?.partial ? "PARTIAL SAMPLE" : "OBSERVED SAMPLE";
  ...
  return <main className={`experience ${entered ? "experience--entered" : ""}`}>
    ...
    <div className="universe-ui" aria-hidden={!entered} inert={!entered}>
      ...
      {!focus && <div className="scene-heading"><p className="eyebrow">{displayFeed?.partial ? sampleProvenance : "EXPLORE THE SIGNAL"}</p><h2>A map of what matters.</h2><p>Ideas gather. Connections form. Attention moves.</p></div>}
