...
Apply the same source reservation when merging live and archived details into a daily snapshot. Re-sorting by publication time alone after the overview selection can hide those journal papers from time travel.
